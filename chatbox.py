...
class ChatBox:
    def __init__(self, text_color, character, chat_tree):
        self.font = pygame.font.Font("../game_assets/fonts/ByteBounce.ttf")
        ...
        self.main_surface = pygame.Surface((screen_width - 100, 100))
